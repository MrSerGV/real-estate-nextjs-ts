...
const PropertyCard = async ({ property }: PropertyCardProps) => {
    ...
    const { images, type, name, location, rates, beds, baths, square_feet, _id } = await property;
        ...
        <div className='rounded-xl shadow-md relative'>
            ...
            <div className='p-4'>
                ...
                <div className='flex justify-center gap-4 text-gray-500 mb-4'>
                    <p>
                        <FaBed className='md:hidden lg:inline mr-2' /> {beds}
                        <span className='md:hidden lg:inline'>{dict.propertyCard.propertyBeds}</span>
                    </p>
                    <p>
                        <FaBath className='md:hidden lg:inline mr-2' /> {baths}
                ...
                <div className='flex flex-col lg:flex-row justify-between mb-4'>
                    ...
                    >
                        {dict.propertyCard.propertyDetails}
                    </Link>
                </div>
            </div>
        </div>
